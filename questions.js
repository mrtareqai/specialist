...
const questions = [
    ...
    {
        id: 19,
        text: "عند مواجهة موقف جديد ومعقد، ما أول ما تميل إلى فعله؟",
        category: "general",
        options: [
            { 
                text: "تحليل الأسباب ومحاولة فهم كيف يعمل كل شيء", 
                scores: { science: 3, medicine: 2, agriculture: 1 } 
            },

            { 
                text: "تنظيم الموقف ووضع خطة لاتخاذ القرار", 
                scores: { business: 3, law: 1, computer: 1 } 
            },

            { 
                text: "التفكير في طريقة عملية أو تقنية لحل المشكلة", 
                scores: { engineering: 3, computer: 3, science: 1 } 
            },

            { 
                text: "التواصل مع الآخرين وفهم احتياجاتهم قبل التصرف", 
                scores: { education: 3, medicine: 1, law: 1 } 
            }
        ]
    },
    {
    ...
    {
        id: 28,
        text: "عندما تصادف موضوعًا جديدًا لا تعرفه، ماذا يحدث غالبًا؟",
        category: "general",
        options: [
            { 
                text: "أبحث عنه فورًا وأحاول فهمه بعمق", 
                scores: { science: 3, computer: 3, law: 2 } 
            },

            { 
                text: "أتعلمه إذا كان مفيدًا لما أعمل عليه", 
                scores: { engineering: 2, medicine: 2, education: 1 } 
            },

            { 
                text: "أشعر بالفضول وأحب استكشافه حتى دون حاجة مباشرة", 
                scores: { science: 3, arts: 1, computer: 2 } 
            },

            { 
                text: "أتجاهله غالبًا إذا لم أحتجه الآن", 
                scores: { agriculture: 2, business: 1, arts: 1 } 
            }
        ]
    },
    {
    ...
    {
        id: 31,
        text: "كيف تتصرف إذا أخبرك شخص أنه يعاني من مشكلة صحية وطلب رأيك؟",
        category: "medicine",
        options: [
            {
                text: "أحاول مساعدته واقتراح ما قد يفيده",
                scores: { medicine: 4 }
            },
            {
                text: "أنصحه بمراجعة مختص أو طبيب",
                scores: { law: 2, business: 1 }
            },
            {
                text: "أستمع إليه باهتمام وأدعمه",
                scores: { education: 2 }
            },
            {
                text: "أبحث عن معلومات لفهم الحالة بشكل أفضل",
                scores: { science: 2 }
            }
        ]
    },
    ...
    },
    {
        ...
        options: [
            ...
            { text: "أهتم بالتأثير البيئي لها", scores: { agriculture: 3, science: 2 } },
    ...
    {
        id: 55,
        text: "كيف تشعر عند شرح فكرة لشخص لا يفهمها؟",
        category: "education",
        options: [
            { text: "أستمتع بتبسيطها حتى يفهمها", scores: { education: 4 } },

            { text: "أحاول المساعدة إذا احتاج الأمر", scores: { business: 2, media: 1 } },

            { text: "أفضل مناقشة الأفكار بعمق أكثر من شرحها للمبتدئين", scores: { science: 3 } },

            { text: "أفضل التركيز على عملي بدل تعليم الآخرين", scores: { engineering: 1, computer: 1 } }
        ]
    },
    ...
    // الإعلام والاتصال (5 أسئلة)
    {
        ...
        category: "media",
        options: [
            { text: "نعم، وأشعر بالحماس", scores: { media: 4, education: 2 } },
    ...
    {
        id: 71,
        text: "كيف تتعامل مع مهمة تتطلب دقة ومتابعة تفاصيل كثيرة؟",
        category: "science",
        options: [
            { text: "أستمتع بها وأركز حتى أصل لنتيجة دقيقة", scores: { science: 4, medicine: 2 } },

            { text: "أؤديها جيدًا إذا كانت الخطوات واضحة", scores: { engineering: 2, computer: 1 } },

            { text: "أفضل المهام العامة على التفاصيل الدقيقة", scores: { law: 1, education: 1 } },

            { text: "أتجنب الأعمال التي تحتاج متابعة دقيقة طويلة", scores: { arts: 1, business: 1 } }
        ]
    },
    {
        id: 72,
    ...
    {
        id: 76,
        text: "عند القيام بمهمة طويلة، أي أسلوب تفضّله لإنجازها؟",
        category: "agriculture",
        options: [
            { text: "العمل تدريجيًا مع متابعة النمو والتغيّر مع الوقت", scores: { agriculture: 4, science: 2 } },

            { text: "تقسيمها إلى خطوات واضحة وإنجازها بدقة", scores: { medicine: 1, education: 1 } },

            { text: "إنجازها بسرعة باستخدام الأدوات التقنية", scores: { computer: 1, business: 1 } },

            { text: "الاعتماد على الإبداع دون الالتزام بخطة ثابتة", scores: { arts: 1, law: 1 } }
        ]
    },
    {
        id: 77,
    ...
    {
    id: 79,
    text: "عند وجود تقنية جديدة تحسّن الإنتاج في أي مجال، كيف تتعامل معها؟",
    category: "agriculture",
    options: [
        { text: "أبحث عنها وأحاول فهم كيف يمكن تطوير العمل بها", scores: { agriculture: 4, engineering: 2 } },
        { text: "أجربها إذا كانت مفيدة وواضحة الفائدة", scores: { science: 2, business: 1 } },
        { text: "أفضل الطرق المعتادة التي أثبتت نجاحها", scores: { agriculture: 3 } },
        { text: "لا أهتم كثيرًا بالتقنيات الجديدة", scores: { computer: 1, media: 1 } }
    ]
    },
    {
        id: 80,
        text: "كيف تتعامل مع شيء يعتمد نجاحه على الاستمرارية على مدى طويل؟",
        category: "agriculture",
        options: [
            { text: "أهتم بالمتابعة المستمرة حتى تظهر النتائج تدريجيًا", scores: { agriculture: 4, science: 2 } },
            { text: "أضع خطة وأراجع النتائج بين فترة وأخرى", scores: { engineering: 2, medicine: 1 } },
            { text: "أركز على النتائج السريعة أكثر من الطويلة", scores: { business: 1, law: 1 } },
            { text: "أفضل المشاريع القصيرة والواضحة النهاية", scores: { arts: 1, media: 1 } }
        ]
    }
];
